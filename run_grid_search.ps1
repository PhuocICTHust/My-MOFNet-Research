...
Write-Host "STARTING GRID SEARCH & ABLATION STUDY..." -ForegroundColor Cyan
...
if ($failures.Count -eq 0) {
    Write-Host "GRID SEARCH COMPLETED -- all runs succeeded." -ForegroundColor Cyan
} else {
    Write-Host "GRID SEARCH COMPLETED WITH $($failures.Count) FAILURE(S):" -ForegroundColor Red
